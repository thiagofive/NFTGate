...
const Home: NextPage = ({
  ...
  return (
    <Container>
      <Head>
        <title>Membership content gate</title>
      ...
      <Center flexDirection="column">
        ...
        <Text>
          ATOOO This is private content for people who have this NFT.
        </Text>
        <Text>Imagine the stuff like gated gonent and what not that could go here</Text>
      </Center>
    </Container>
  );
};
